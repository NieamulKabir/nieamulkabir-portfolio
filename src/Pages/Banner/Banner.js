        ...
        <div className="flex flex-col items-center justify-between lg:flex-row ">
          ...
          <div className="mb-10 lg:max-w-lg  lg:ml-0 lg:mb-0">
            <div className="max-w-xl mb-6 lg:mt-2">
              <Bounce top>
                <h1 className="text-xl lg:text-3xl pb-5 font-thin text-left text-white">
                  HELLO
                </h1>
                <h1 className="text-2xl lg:text-4xl font-bold text-left text-white">
                  I'm <span className="text-green-300">Md.Nieamul Kabir</span>{" "}
                </h1>
              </Bounce>
              <h2 className="text-xl  lg:text-3xl font-bold pt-5 mb-16 text-left text-white">
                <span>
                  <Typewriter
                    loop
                    cursor
              ...
              <h1 className="text-left">
                <a
                  href="https://drive.google.com/file/d/1a35nhankfQO0p6m2GYBst9dHT2RdfmgS/view?usp=sharing"
                  target="_blank"
                  rel="noreferrer"
                  className="hover:bg-zinc-800 hover:text-white shadow-emerald-400/30 shadow-lg transition duration-500 mx-auto px-8 py-4  lg:px-8 lg:py-4  bg-emerald-400 rounded-full text-zinc-800 font-semibold text-left"
                >
                  Download Resume
                </a>
              </h1>
