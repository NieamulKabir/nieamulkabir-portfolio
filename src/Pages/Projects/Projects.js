        ...
        <div className="container mx-auto  bg-gray-500 pb-20">
          ...
          <Tabs>
            ...
            {/* <TabPanel id="React" className="">
              <h2 className="mt-10 mb-10 text-white text-2xl font-semibold">
                  ...
                  .map((myReactProjects) => (
                    ...
                    >
                      <div className="card bg-base-100 md:h-[650px] shadow-xl">
                        <figure>
                          <img
                            className="w-full h-[310px] m-2  rounded-2xl"
                        ...
                        <div className="card-body">
                          <div>
                            ...
                            <p className="text-sm mb-2 text-slate-800 font-light">
                              {myReactProjects.projectType}
                            </p>
                            <h2>Technology Used:</h2>
                            <div className="mt-2">
                              <button className=" transform transition cursor-default duration-300 hover:scale-110 px-3 font-light py-1 text-sm  bg-gray-700 text-white rounded-full m-1">
                                JSX
                              </button>
                              <button className="transform transition cursor-default duration-300 hover:scale-110 px-3 font-light py-1 text-sm  bg-gray-700 text-white rounded-full m-1">
                                JavaScript
                            ...
                            <div className=" mt-4">
                              <NavLink
                                ...
                                className="px-5 mx-2 bg-gray-700 text-white py-2 rounded hover:bg-slate-300 hover:text-slate-700 transition duration-300 animate-infinite "
                              >
                                View Details
                              </NavLink>
                            </div>
            ...
            <TabPanel id="Javascript" className="">
              <h2 className="mt-10 mb-10 text-white text-2xl font-semibold">
                Projects using using html, css & Javascript
              </h2>
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-5 px-6 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-2 ">
                {projects
                  .filter(
            ...
            <TabPanel id="html" className="">
              <h2 className="mt-10 mb-10 text-white text-2xl font-semibold">
                Projects using html,css only & bootstrap
              </h2>
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-5 px-6 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-2 ">
                {projects
                  .filter(
